...
- Name: playwright-pdf-upload: PDF Upload and Form Validation >> should upload both PDFs (Rechnung + Kreditkartenbeleg) and handle multiple files
- Location: /Users/daniel/dev/Bewritung/bewir/test/playwright-3-pdf-upload.spec.ts:419:3
