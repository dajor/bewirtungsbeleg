...
- Name: E2E Test 5: Foreign Currency Receipt Handling >> should validate exchange rate format
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:389:3
...
Call log:
  - waiting for locator('input[name="restaurantName"], textarea[name="restaurantName"]')
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:390:16
```
