...
- Name: playwright-login: Login Flow >> should login with existing credentials and redirect to main app
- Location: /Users/daniel/dev/Bewritung/bewir/test/playwright-2-login.spec.ts:22:3
...
Locator: locator('text=/Willkommen zurück/i')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for locator('text=/Willkommen zurück/i')
    - waiting for" http://localhost:3000/auth/anmelden" navigation to finish...
    - navigated to "http://localhost:3000/auth/anmelden"

    at /Users/daniel/dev/Bewritung/bewir/test/playwright-2-login.spec.ts:30:61
```
...
```ts
   1 | /**
   2 |  * Playwright E2E Test: Login Flow
   3 |  *
   4 |  * Tests login with credentials from playwright-register test:
   5 |  * 1. Navigate to signin page
   6 |  * 2. Login with Test Tester credentials
   7 |  * 3. Verify redirect to /bewirtungsbeleg
