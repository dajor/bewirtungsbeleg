...
- Location: /Users/daniel/dev/Bewritung/bewir/test/playwright-4-multi-pdf-combinations.spec.ts:148:3

# Error details

```
Error: locator.inputValue: Error: strict mode violation: getByLabel('Trinkgeld') resolved to 2 elements:
    1) <input type="text" value="2.10" inputmode="numeric" aria-invalid="false" data-path="trinkgeld" data-variant="default" id="mantine-mikn9ki1o" placeholder="Trinkgeld in Euro" aria-describedby="mantine-mikn9ki1o-description" class="m_8fb7ebe7 mantine-Input-input mantine-NumberInput-input"/> aka getByRole('textbox', { name: 'Trinkgeld', exact: true })
    2) <input readonly type="text" value="0.40" inputmode="numeric" aria-invalid="false" data-variant="default" id="mantine-01hl9tyo7" data-path="trinkgeldMwst" placeholder="MwSt. in Euro" aria-describedby="mantine-01hl9tyo7-description" class="m_8fb7ebe7 mantine-Input-input mantine-NumberInput-input"/> aka getByRole('textbox', { name: 'MwSt. Trinkgeld' })
...
Call log:
  - waiting for getByLabel('Trinkgeld')
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/playwright-4-multi-pdf-combinations.spec.ts:162:5
```
