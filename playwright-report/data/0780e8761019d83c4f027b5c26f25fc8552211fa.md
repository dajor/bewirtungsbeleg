...
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-complete-workflow.spec.ts:157:3
...
Call log:
  - waiting for locator('input[type="file"][accept*="image"], input[type="file"][accept*="pdf"]').first()
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/e2e-complete-workflow.spec.ts:189:5
```
