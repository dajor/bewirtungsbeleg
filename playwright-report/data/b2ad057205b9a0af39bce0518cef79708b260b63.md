...
- Name: PDF to Image Conversion >> should clear error when removing PDF file
- Location: /Users/daniel/dev/Bewritung/bewir/test/pdf-conversion.spec.ts:201:3
...
Call log:
  - waiting for locator('input[type="file"][accept*="image"], input[type="file"][accept*="pdf"]').first()
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/pdf-conversion.spec.ts:223:5
```
