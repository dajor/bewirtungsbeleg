...
- Location: /Users/daniel/dev/Bewritung/bewir/test/playwright-4-multi-pdf-combinations.spec.ts:167:3

# Error details

```
Error: locator.inputValue: Error: strict mode violation: getByLabel('Trinkgeld') resolved to 2 elements:
    1) <input type="text" value="2.10" inputmode="numeric" aria-invalid="false" data-path="trinkgeld" data-variant="default" id="mantine-h7w735atv" placeholder="Trinkgeld in Euro" aria-describedby="mantine-h7w735atv-description" class="m_8fb7ebe7 mantine-Input-input mantine-NumberInput-input"/> aka getByRole('textbox', { name: 'Trinkgeld', exact: true })
    2) <input readonly type="text" value="0.40" inputmode="numeric" aria-invalid="false" data-variant="default" id="mantine-hnn5l4wgz" data-path="trinkgeldMwst" placeholder="MwSt. in Euro" aria-describedby="mantine-hnn5l4wgz-description" class="m_8fb7ebe7 mantine-Input-input mantine-NumberInput-input"/> aka getByRole('textbox', { name: 'MwSt. Trinkgeld' })
...
Call log:
  - waiting for getByLabel('Trinkgeld')
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/playwright-4-multi-pdf-combinations.spec.ts:185:5
```
