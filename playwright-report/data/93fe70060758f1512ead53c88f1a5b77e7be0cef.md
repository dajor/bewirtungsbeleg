...
- Name: E2E Test 3: Error Recovery and Retry >> should handle network timeout gracefully
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:236:3
...
Call log:
  - waiting for locator('input[name="restaurantName"], textarea[name="restaurantName"]')
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:248:16
```
