...
- Name: PDF to Image Conversion >> should enable rotation controls after PDF conversion
- Location: /Users/daniel/dev/Bewritung/bewir/test/pdf-conversion.spec.ts:138:3
...
Call log:
  - waiting for locator('input[type="file"][accept*="image"], input[type="file"][accept*="pdf"]').first()
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/pdf-conversion.spec.ts:152:5
```
