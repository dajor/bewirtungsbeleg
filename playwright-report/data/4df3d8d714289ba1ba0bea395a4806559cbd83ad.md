...
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-tip-calculation.spec.ts:113:3
...
Call log:
  - waiting for locator('text=Rechnung hochladen').locator('..').locator('..').locator('input[type="file"]')
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/e2e-tip-calculation.spec.ts:118:5
```
