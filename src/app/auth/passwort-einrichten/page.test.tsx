...
describe('SetupPasswordPage', () => {
  ...
  describe('Form Submission', () => {
    ...
    it('should redirect to signin after 3 seconds', async () => {
      ...
      expect(mockPush).toHaveBeenCalledWith('/auth/anmelden?setup=success');
  ...
  describe('UI Elements', () => {
    ...
    it('should display back to signin link', async () => {
      ...
      await waitFor(() => {
        ...
        expect(signinLink.closest('a')).toHaveAttribute('href', '/auth/anmelden');
      });
    });
