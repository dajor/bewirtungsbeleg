...
- Name: E2E Test 3: Error Recovery and Retry >> should recover from OCR API failure
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:185:3
...
Call log:
  - waiting for locator('input[type="file"][accept*="image"]').first()
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:219:5
```
