...
- Name: E2E Test 4: Form Validation with German Formats >> should validate German decimal format
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:286:3
...
Call log:
  - waiting for locator('input[name="restaurantName"], textarea[name="restaurantName"]')
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:287:16
```
