...
- Name: Tip Calculation - OCR Extraction >> should auto-calculate tip after OCR extracts both invoice and credit card
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-tip-calculation.spec.ts:117:3
...
- button "JSON Download":
  ...
  - text: JSON Download
- img
- button "08102025_Bezahlung MASTERCARD.pdf"
- button:
  - img
