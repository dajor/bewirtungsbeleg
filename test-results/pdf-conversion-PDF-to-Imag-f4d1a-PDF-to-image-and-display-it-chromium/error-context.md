...
- Name: PDF to Image Conversion >> should convert PDF to image and display it
- Location: /Users/daniel/dev/Bewritung/bewir/test/pdf-conversion.spec.ts:104:3
...
Call log:
  - waiting for locator('input[type="file"][accept*="image"], input[type="file"][accept*="pdf"]').first()
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/pdf-conversion.spec.ts:123:5
```
