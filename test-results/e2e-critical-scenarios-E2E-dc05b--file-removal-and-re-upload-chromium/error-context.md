...
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:155:3
...
Call log:
  - waiting for locator('input[type="file"][accept*="image"]').first()
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:162:5
```
