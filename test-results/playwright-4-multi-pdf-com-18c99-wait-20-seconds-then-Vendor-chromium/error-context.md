...
- Name: playwright-4-multi-pdf-combinations: Critical Multi-PDF Upload Tests >> Test 4: Kundenbeleg first, wait 20 seconds, then Vendor
- Location: /Users/daniel/dev/Bewritung/bewir/test/playwright-4-multi-pdf-combinations.spec.ts:257:3
...
Call log:
  - waiting for locator('input[type="file"][accept*="image"], input[type="file"][accept*="pdf"]').first()
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/playwright-4-multi-pdf-combinations.spec.ts:261:5
```
