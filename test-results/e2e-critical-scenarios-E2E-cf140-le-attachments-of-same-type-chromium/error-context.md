...
- Name: E2E Test 2: Multiple File Handling with Ordering >> should handle multiple attachments of same type
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:131:3
...
Call log:
  - waiting for locator('input[type="file"][accept*="image"]').first()

    at BewirtungsbelegPage.uploadFiles (/Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:26:5)
    at /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:143:5
```
