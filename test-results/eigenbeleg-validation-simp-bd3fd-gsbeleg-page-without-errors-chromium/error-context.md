...
- Name: Eigenbeleg Validation Fix >> should load bewirtungsbeleg page without errors
- Location: /Users/daniel/dev/Bewritung/bewir/test/eigenbeleg-validation-simple.spec.ts:10:3
...
Locator: locator('h1:has-text("Bewirtungsbeleg")')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('h1:has-text("Bewirtungsbeleg")')

    at /Users/daniel/dev/Bewritung/bewir/test/eigenbeleg-validation-simple.spec.ts:16:66
```
