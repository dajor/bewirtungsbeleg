...
- Name: E2E Test 5: Foreign Currency Receipt Handling >> should handle foreign currency receipt without VAT
- Location: /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:369:3
...
Call log:
  - waiting for locator('input[name="restaurantName"], textarea[name="restaurantName"]')
    ...
    at /Users/daniel/dev/Bewritung/bewir/test/e2e-critical-scenarios.spec.ts:370:16
```
